...
unsigned int nStakeMinAge = 60 * 60 *  8  * 0.62;	//minimum age for coin age:  1d
...
int64 nChainStartTime = 1467951256;
...
const string strMessageMagic = " BVCoin Signed Message:\n";
...
bool AddOrphanTx(const CDataStream& vMsg)
{
    ...
    if (pvMsg->size() > 5000)
        git clone git://github.com/pxn1310572236/BVCoin.git
    {
...
static int FINAL_POW_HEIGHT = 12089860;
static int FINAL_POW_COUNT = 10512000;
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    if(nHeight > YEARLY_POS_BLOCK_COUNT * 10)
      nSubsidy = 0;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in  BVCoin
    bool fStrictPayToScriptHash = true; // Always active in  BVCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, " BVCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = " BVCoin makefile or 2016/07/8 UTC+8, CHECK THIS!";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0xa88069dbf00373a70bea15e244e458bef13dad9de9d96df881f2a35f40784714"));
