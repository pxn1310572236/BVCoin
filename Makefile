#############################################################################
# Makefile for building: MICACoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? ?? 7 23:04:34 2016
# Project:  micacoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_UPNP=- USE_QRCODE=1 -o Makefile micacoin-qt.pro
#############################################################################
...
Makefile: micacoin-qt.pro  ../Qt/4.8.6/mkspecs/default/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_UPNP=- USE_QRCODE=1 -o Makefile micacoin-qt.pro
